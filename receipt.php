...
<body class="inter bg-gray-600">
    ...
    <div class="container mx-auto px-4 py-10 space-y-10">
        <div class="bg-white mx-auto rounded-lg shadow-xl flex flex-col justify-center items-center px-5">
            ...
            <div class="flex w-full items-center py-4 px-3 justify-between border-b border-dashed border-black">
                <h1 class="font-semibold text-xl text-blue-500">Booking Details
                    ...
                    <p class="font-normal text-black text-sm">Trip Type: <?php if ($triptype == 2) {
                                                                                echo "Round Trip";
                                                                            } else {
                                                                                echo "One Way";
                                                                            } ?> </p>
            ...
            <div class="flex flex-col w-full py-4 px-3 justify-start border-b-4 border-yellow-300">
                <h1 class="font-semibold text-xl text-blue-500">Passenger Details</h1>
                <div class="flex flex-wrap justify-around items-center p-4">
                    <?php
                    $guests = $result['name'];
                    echo "<p class='font-normal text-black'><b>Fullname : </b>$guests</p>";
                    ?>
                    <p class='font-normal text-black'><b>Address : </b><?php echo $result['address']; ?></p>
                    <p class='font-normal text-black'><b>Contact Number : </b><?php echo $result['contact']; ?></p>
                </div>
            </div>
            ...
            <div class="flex flex-col w-full py-4 px-3 justify-start space-y-8 mb-10">
                ...
                <table class="w-full table-auto">
                    ...
                    <tbody class="text-center pt-10">
                        <tr>
                            ...
                            <?php } else { ?>
                                <td><?php echo $departure_airport; ?> to <?php echo $arrival_airport; ?>
                                    <hr>
                                    <?php echo $arrival_airport; ?> to <?php echo $departure_airport; ?>
                                </td>
                            <?php } ?>
                ...
                <div class="border-4 border-gray-300 p-5 pb-10 space-y-5">
                    ...
                    <ul class="list-inside list-disc px-8">
                        <li class="italic">Passenger needing transfers between Manila’s airport terminals may take the free Manila International Airport Authority shuttle buses. These have regular trips between Terminals 1, 2, 3 and 4. Other terminal transfer options are also available, at a cost.</li>
                    </ul>
                </div>
        ...
        <div class="bg-white mx-auto w-1/3 rounded-lg shadow-xl flex flex-col justify-center items-center py-5">
            ...
            <div class="flex justify-around">
                <h1 class="tracking-tight text-center">Trip Type: <?php if ($triptype == 2)  echo "Round Trip";
                                                                    else  echo "One Way";  ?> </h1>
            </div>
